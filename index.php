...
<body>
    ...
    <header>
        <div class="nav container">
            ...
            <ul class="navbar">
                ...
                <li><a href="#salesproperties">Sales Properties</a></li>
    ...
    <section class="about container" id="about">
        ...
        <div class="about-text">
            <span>About Us</span>
            <h2>We Provide The Best <br>house For You !</h2>
    ...
    <section class="rent container" id="rent">
        ...
        <div class="rent-container container">
            ...
            <!-- Box 3 -->
            <div class="box">
                <img src="img/png3.jpg" alt="">
                <h3>25,000tk</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
                        <p>Tongi ,Gazipura 27</p>
                    </div>
                    <div class="icon">
                        <i class='bx bx-bed' ><span>5</span></i>
                        <i class='bx bx-bath' ><span>2</span></i>
            ...
            <!-- Box 4 -->
            <div class="box">
                <img src="img/png4.jpg" alt="">
                <h3>15,500tk</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
                        <p>Merul Badda, nimtoli</p>
                    </div>
                    <div class="icon">
                        <i class='bx bx-bed' ><span>5</span></i>
                        <i class='bx bx-bath' ><span>2</span></i>
            ...
            <!-- Box 5 -->
            <div class="box">
                <img src="img/png5.jpg" alt="">
                <h3>25,500tk</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
                        <p>Boshundhora , shohid azizul road</p>
                    </div>
                    <div class="icon">
                        <i class='bx bx-bed' ><span>5</span></i>
                        <i class='bx bx-bath' ><span>2</span></i>
            ...
            <!-- Box 6 -->
            <div class="box">
                <img src="img/png6.jpg" alt="">
                <h3>45,000tk</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
                        <p>Tongi,  gazipur chowrasta</p>
                    </div>
                    <div class="icon">
                        <i class='bx bx-bed' ><span>5</span></i>
                        <i class='bx bx-bath' ><span>2</span></i>
    ...
    <section class="newsletter container">
        ...
        <form action="">
            <input type="email" name="" id="email-box" placeholder=" enteryourmail" required>
